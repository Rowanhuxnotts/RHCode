...
# Pauses happened every 15 presentations (Every 5 presentations of each stimuli)
# 
...
BP9 = np.count_nonzero(BP9Bin, axis=0)
BP75 = np.count_nonzero(BP75Bin, axis=0)
BP6 = np.count_nonzero(BP6Bin, axis=0)
